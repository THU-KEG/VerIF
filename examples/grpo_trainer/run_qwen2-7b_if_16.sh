...
if_train_path=$HOME/data/if_prompts_2/train.parquet
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/mnt/ph/ScaleIF/alignment-handbook/models/sft/qw25_7b_v1 \
    ...
    trainer.experiment_name='qwen25_7b_if-16' \
